...
def add_assert(token):
    ...
    add_assert_url = "https://192.168.4.107:8440/userpermission/usermanage/delete"
    ...
    res = requests.delete(url=add_assert_url, headers=add_assert_header, json=add_assert_body, verify=False)
